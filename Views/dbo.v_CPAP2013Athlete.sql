...
CREATE VIEW [dbo].[v_CPAP2013Athlete]
AS
SELECT    a.CpapAthleteId, a.PersonId, a.AccountCreationDate, a.LastLogon, a.NumberOfVisits, 
          a.UserType, a.AffiliateId, a.MonthsOnSystem, a.MonthsOnSystemSince2013, a.MonthsActiveOnSystem, a.MonthsActiveOnSystemSince2013, 
          a.PercentOfMonthsActiveOnSystem, a.PercentOfMonthsActiveOnSystemSince2013, a.TrialPremiumSubCouponUsed, 
          ...
          a.PercentFatMetric, LapseCount, RenewSaleCount, RecurSaleCount, a.FavoriteFoodCount, a.DaysSinceLastPremSub, DaysToPremSub, a.FirstPremTerm, a.DateAdded
FROM      dbo.Cpap2013Athlete As a LEFT OUTER JOIN dbo.Cpap_2013WorkoutInfo As w ON w.PersonId = a.PersonId
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'v_CPAP2013Athlete', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'v_CPAP2013Athlete', NULL, NULL
GO
