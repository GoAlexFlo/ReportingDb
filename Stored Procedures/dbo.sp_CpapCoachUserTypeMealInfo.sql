...
CREATE PROCEDURE [dbo].[sp_CpapCoachUserTypeMealInfo] 
			...
			( 
			  ...
			  (
				...
				(
  				...
  				), dataPass4 As -- Summarize Data
  			    (  Select c.CoachId, 
  			              CONVERT(VARCHAR(10),c.UserType) As UserType, 
  			    ...
  			    Select CoachId, 
  			           ...
  			           SUM(PlannedLoggedMealCount) As PlannedLoggedMealCount, 
  			           SUM(UnPlannedLoggedMealCount) As UnPlannedLoggedMealCount, 
  			           SUM(PlannedMealMonths) As PlannedMealMonths,
  			           SUM(PlannedUnLoggedMealMonths) As PlannedUnLoggedMealMonths, 
  			           SUM(PlannedLoggedMealMonths) As PlannedLoggedMealMonths,
  			           SUM(UnPlannedLoggedMealMonths) As UnPlannedLoggedMealMonths
  			    From dataPass4
		        Group By CoachId
		        Having Count(*)>1
		        Order By CoachId
