...
CREATE PROCEDURE [dbo].[sp_CpapWorkoutInfo] 
...
SET @Sql = '
BEGIN
		TRUNCATE TABLE ' + @DestinationDbName + '..[Cpap_WorkoutInfo]
				   
		Insert Into ' + @DestinationDbName + '..[Cpap_WorkoutInfo]
				   ([PersonId]
		...
		Where ' + @WhereCondition + ' And (PlanId <> 30819 Or PlanId Is Null)
