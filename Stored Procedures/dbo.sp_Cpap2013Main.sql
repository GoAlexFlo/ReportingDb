...
CREATE PROCEDURE [dbo].[sp_Cpap2013Main] 
...
SET @WhereCondition = 'p.Usertype in (1,4,6) And p.PersonId Not In (349077, 114420)'
 PRINT 1      
	   ...
	   EXEC sp_Cpap2013AthleteInfo @SourceDbName, @DestinationDbName, @WhereCondition, @WhereConditionYear   
	   ...
	   EXEC sp_Cpap2013MealInfo @SourceDbName, @DestinationDbName, @WhereCondition, @WhereConditionYear	  
  	   
	   CREATE TABLE #MonthsOnSystemInfo (PersonId INT, MonthsOnSystem INT, MonthsOnSystemSince2013 INT, MonthsActiveOnSystem INT, 
	                                     MonthsActiveOnSystemSince2013 INT, PercentOfMonthsActiveOnSystem FLOAT, PercentOfMonthsActiveOnSystemSince2013 FLOAT)
	   INSERT INTO #MonthsOnSystemInfo
	   EXEC sp_Cpap2013MonthsOnSystemInfo @SourceDbName, @DestinationDbName, @WhereCondition, @WhereConditionYear
	   ...
	   --CREATE TABLE #GaVisitsInfo (PersonId INT, GaAppiOSVisits INT, GaAppAndroidVisits INT, GaWebDesktopVisits INT, GaWebiOSVisits INT, GaWebAndroidVisits INT, GaOtherVisits INT)
	   --INSERT INTO #GaVisitsInfo
	   --EXEC sp_CpapGoogleAnalyticsInfo @SourceDbName, @DestinationDbName, @WhereCondition, @WhereConditionYear
	   
    INSERT INTO Reporting..Cpap2013Athlete
		  ([PersonId]
		  ,[AccountCreationDate]
		  ,[LastLogon]
		  ,[NumberOfVisits]
	      ...
	      ,[UnPlannedLoggedMealMonths]
  		  ,[MonthsOnSystem]
       	  ,[MonthsOnSystemSince2013]
       	  ,[MonthsActiveOnSystem]
       	  ,[MonthsActiveOnSystemSince2013]
       	  ,[PercentOfMonthsActiveOnSystem]
       	  ,[PercentOfMonthsActiveOnSystemSince2013]
		  ,[MonthsAsUserType1]
    ...
    SELECT a.PersonId, 
	       ...
	       j.UnPlannedLoggedMealMonths,
       	   k.MonthsOnSystem,
       	   k.MonthsOnSystemSince2013,
       	   k.MonthsActiveOnSystem,
       	   k.MonthsActiveOnSystemSince2013,
       	   k.PercentOfMonthsActiveOnSystem,
       	   k.PercentOfMonthsActiveOnSystemSince2013,
		   l.MonthsAsUserType1,
		   ...
		   t.FavoriteFoodCount,
		-- u.GaAppiOsVisits,
		-- u.GaAppAndroidVisits,
	    -- u.GaWebiOSVisits, 
	    -- u.GaWebAndroidVisits,
	    -- u.GaWebDesktopVisits, 
	    -- u.GaOtherVisits,
	       null,
	       null,
	       null,
