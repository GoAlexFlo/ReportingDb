...
CREATE PROCEDURE [dbo].[sp_CpapMealInfo] 
	   ...
	   'BEGIN
			...
			( 
			  ...
			  (
				...
				(
  					Select 	PersonId, Title, [Description], MealDate, PlannedMealCount, PlannedUnLoggedMealCount, PlannedLoggedMealCount, UnPlannedLoggedMealCount,
  					        PlannedMealMonth, PlannedLoggedMealMonth, PlannedUnLoggedMealMonth, UnPlannedLoggedMealMonth, 
  							TotalCalories,MealRecipe, UserComments, Count(*) As dups
  					From dataPass2
  					Group by PersonId, Title, [Description], MealDate, PlannedMealCount, PlannedUnLoggedMealCount, PlannedLoggedMealCount, UnPlannedLoggedMealCount,
  					         PlannedMealMonth, PlannedLoggedMealMonth, PlannedUnLoggedMealMonth, UnPlannedLoggedMealMonth,
  					         TotalCalories,MealRecipe, UserComments
  				) -- Summarize Data
  			        Select  PersonId,
