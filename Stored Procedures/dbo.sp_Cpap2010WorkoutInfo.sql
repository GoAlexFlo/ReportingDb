...
CREATE PROCEDURE [dbo].[sp_Cpap2010WorkoutInfo] 
...
SET @Sql = '
BEGIN
		TRUNCATE TABLE ' + @DestinationDbName + '..[Cpap_2010WorkoutInfo]
				   
		Insert Into ' + @DestinationDbName + '..[Cpap_2010WorkoutInfo]
				   ([PersonId]
		...
		From ' + @DestinationDbName + '..v_Workout2010 w
