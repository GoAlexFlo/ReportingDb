...
CREATE PROCEDURE [dbo].[sp_CpapCoachPlanInfo] 
		...
		As
		   (
			-- Determine If BoughtWorkoutPlan	 
				Select a.PersonId,  a.CoachId, Convert(Date, pp.TransactionDate) As TransactionDate, CoachedFromDate, CoachedToDate,
			...
			-- Determine If CoachSuppliedWorkoutPlan	 
				Select  a.PersonId, a.CoachId, ''1901-01-01'' As TransactionDate, a.CoachedFromDate, CoachedToDate,  
...
Set @Sql02 = 	
		  ' Union All
			-- Determine If CoachSuppliedWorkoutPlan From AppliedPlan	 
				Select c.PersonId, c.CoachId, Convert(Date, a.DateAdded) As TransactionDate, CoachedFromDate, CoachedToDate,     
					   0 As BoughtWorkoutPlan, 0 As BoughtNutritionPlan, 0 As BoughtNutritionAndWorkoutComboPlan, 0 As BoughtWorkoutLibrary, 
					   1 As CoachSuppliedWorkoutPlan, 0 As CoachSuppliedMealPlan, 0 As AppliedPlanCount  
			...
			-- Determine If CoachSuppliedMealPlan	 
				Select  a.PersonId, a.CoachId, ''1901-01-01'' As TransactionDate, CoachedFromDate, CoachedToDate,   
						0 As BoughtWorkoutPlan, 0 As BoughtNutritionPlan, 0 As BoughtNutritionAndWorkoutComboPlan, 0 As BoughtWorkoutLibrary, 
			...
			-- Determine If CoachSuppliedMealPlan From AppliedPlan
				Select c.PersonId, c.CoachId, Convert(Date, a.DateAdded) As TransactionDate, c.CoachedFromDate, CoachedToDate,     
					   0 As BoughtWorkoutPlan, 0 As BoughtNutritionPlan, 0 As BoughtNutritionAndWorkoutComboPlan, 0 As BoughtWorkoutLibrary, 
					   1 As CoachSuppliedWorkoutPlan, 0 As CoachSuppliedMealPlan, 0 As AppliedPlanCount  
				From ' + @DestinationDbName + '..CoachedAthletes As c Inner Join ' + @SourceDbName + '..AppliedPlan as a On c.PersonId=a.PersonId  And Convert(Date, a.DateAdded) Between c.CoachedFromDate And c.CoachedToDate
													 Inner Join ' + @SourceDbName + '..[Plan] as p On a.PlanId=p.PlanId
			...
			-- Count How Many plan where Applied	 
				Select a.PersonId, c.CoachId, Convert(Date, a.DateAdded) As TransactionDate, CoachedFromDate, CoachedToDate,    
					   0 As BoughtWorkoutPlan, 0 As BoughtNutritionPlan, 0 As BoughtNutritionAndWorkoutComboPlan, 0 As BoughtWorkoutLibrary, 
		...
		Select CoachId, SUM(BoughtWorkoutPlan) As BoughtWorkoutPlan, 
