...
CREATE PROCEDURE [dbo].[sp_Cpap2010AthleteWorkoutRefresh] 
AS
BEGIN
	SET NOCOUNT ON;
	...
	EXEC    @return_value = [dbo].[sp_Cpap2010WorkoutInfo] @SourceDbName, @DestinationDbName, @WhereCondition, @WhereConditionYear 
END
GO
