...
CREATE PROCEDURE [dbo].[sp_CpapAthleteOnBoardingMain] 
...
SET @WhereCondition = 'p.Usertype in (1,4,6) And p.PersonId Not In (349077, 114420) And p.AccountCreationDate>=''2014-05-07'' '
    ...
    INSERT INTO Reporting..CpapAthleteOnBoarding
		  ([PersonId]
		  ,[AccountCreationDate]
		  ,[LastLogon]
		  ,[NumberOfVisits]
