...
CREATE PROCEDURE [dbo].[sp_Cpap2010WorkoutRevisedInfo] 
...
SET @Sql = '
BEGIN
		TRUNCATE TABLE ' + @DestinationDbName + '..[Cpap_2010WorkoutRevisedInfo]
				   
		Insert Into ' + @DestinationDbName + '..[Cpap_2010WorkoutRevisedInfo]
				   ([PersonId]
		...
		From ' + @DestinationDbName + '..v_Workout2010Revised w
