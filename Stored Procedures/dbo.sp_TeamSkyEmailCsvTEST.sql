...
CREATE PROCEDURE [dbo].[sp_TeamSkyEmailCsvTEST]
AS
BEGIN
SET NOCOUNT ON;
...
(
    ...
    (
		...
		WHERE CONVERT(varchar(10), WorkoutDay, 111) >= ''2011/01/01'' And
		      CONVERT(varchar(10), WorkoutDay, 111) <  ''2013/11/01''
	)
...
The attached CSV file contains Workout/Weight Metric from 01/01/2011 to 11-01-2013.     
...
';
 ...
 --   @blind_copy_recipients=N'ben@peaksware.com',
    @body= @emailBodyMsg,
    @subject ='TEST RUN: WORKOUT DATA FROM 01/01/2011 To 11-01-2013 Weight Metric Mod',
